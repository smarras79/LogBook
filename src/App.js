...
import { getContinent, searchAirports, calculateDistance, getIntermediatePoint } from './utils/geo';
...
const detectLandmarksHybrid = async (origin, dest) => {
  ...
  const {
    ...
    featureStats, topFeatures, airlineStats, topAirlines,
    aircraftStats, allAircraft, topAircraft,
    allianceStats, totalFlightsWithAirlines, sortedAlliances, dominantAlliance,
    classStats, sortedClasses, carbonByClass, sortedCarbonByClass,
